...
CONTAINS
      ...
      INTEGER FUNCTION sbc_dcy_alloc()
         ...
         !
         !!rc WRITE(numout,*) 'sbc_dcy_alloc DEBUG   SHAPE(raa) =', SHAPE(raa)
         !!rc WRITE(numout,*) 'sbc_dcy_alloc DEBUG   jpi, jpj', jpi, jpj
   ...
   FUNCTION sbc_dcy( pqsrin, l_mask ) RESULT( zqsrout )
      ...
      !
      !!rc WRITE(numout,*) 'sbc_dcy DEBUG   nday_qsr =', nday_qsr
      ...
      IF( nday_qsr /= nday ) THEN 
         ...
         !!rc
         !!rc WRITE(numout,*) 'sbc_dcy DEBUG   SHAPE(raa) =', SHAPE(raa)
         DO jj = 1, jpj
            DO ji = 1, jpi
               !!rc WRITE(numout,*) 'sbc_dcy DEBUG   ji, jj =', ji, jj
