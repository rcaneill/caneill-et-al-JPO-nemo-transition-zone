MODULE usrdef_hgr
   ...
   !
   USE usrdef_nam, ONLY: rn_e1_deg, rn_phi0
...
CONTAINS
   ...
   SUBROUTINE usr_def_hgr( plamt , plamu , plamv  , plamf  ,   &   ! geographic position (required)
      ...
      !!-------------------------------------------------------------------------------
      !
      zlam0 = - rn_e1_deg * 0.5_wp   ! so that the first U point is at o degrees of longitude
      ...
      IF ( rn_phi0 == -90 )   CALL ctl_stop( ' Mercator grid cannot start at south pole !!!! ' )
      !
